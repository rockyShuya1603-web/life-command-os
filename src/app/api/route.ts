...
- 日本語で返す`,
    ...
    const system =
      ...
      : mode === "budgetAI" ? "あなたはLife Command OSの家計簿AIです。収入・支出・固定費・残高・カテゴリ増減を横断し、①今月の状態 ②今日使える目安 ③注意カテゴリ ④安心できる次の一手を、やさしく具体的に180〜320字で返してください。診断や断定ではなく、記録整理の補助として話してください。命令口調は禁止です。"
