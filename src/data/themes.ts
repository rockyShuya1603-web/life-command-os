...
export const themes = {
  mirai: {
    name: "未来",
    emoji: "🌐",
    bg: "from-[#020617] via-[#0f2a6b] to-[#020617]",
    card: "bg-slate-950/50 border-sky-200/25 shadow-sky-500/20",
    accent: "from-sky-200 via-blue-300 to-indigo-300",
    pattern: "radial-gradient(circle at 50% 0%, rgba(125,211,252,.22), transparent 35%), radial-gradient(circle at 80% 25%, rgba(129,140,248,.16), transparent 30%)",
    image: "/future-bg.png?v=20260521-future-v13",
  },
  hanabi: {
    name: "花火",
    emoji: "🎆",
    bg: "from-[#12040b] via-[#2d0c24] to-[#05020a]",
    card: "bg-[#170714]/72 border-[#f6c979]/28 shadow-[#ff8a3d]/20",
    accent: "from-[#f6c979] via-[#ff9d4d] to-[#c93855]",
    pattern: "radial-gradient(circle at 20% 20%, rgba(246,201,121,.18) 0 2px, transparent 3px), radial-gradient(circle at 80% 30%, rgba(255,138,61,.16) 0 2px, transparent 3px)",
    image: "/natsumatsuri-bg-v2.png",
  },
  natsumatsuri: {
    name: "夏祭り",
    emoji: "🏮",
    bg: "from-[#12040b] via-[#3a0f21] to-[#07020b]",
    card: "bg-[#170714]/78 border-[#f6c979]/34 shadow-[#ff8a3d]/24",
    accent: "from-[#f6c979] via-[#ff9d4d] to-[#c93855]",
    pattern: "linear-gradient(90deg, rgba(246,201,121,.08) 1px, transparent 1px), linear-gradient(rgba(255,138,61,.06) 1px, transparent 1px)",
    image: "/natsumatsuri-bg-v2.png",
  },
  umi: {
    name: "海",
